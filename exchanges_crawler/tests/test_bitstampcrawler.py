...
class BitstampCrawlerTestCase(TestCase):
    def setUp(self):
        ...
        self.exchange = Exchange.objects.get(name="Bitstamp")
        ...
        self.orderbook_api = "https://www.bitstamp.net/api/v2/order_book/{}{}"
        self.ticker_api = "https://www.bitstamp.net/api/v2/ticker/{}{}"

    def test_crawler_is_properly_created(self):
        exchange = self.exchange

        crawler = BitstampCrawler(exchange)
    ...
    def test_request_pair_api_returns_empty_result_for_empty_api(self):
        ...
        self.assertEquals(BitstampCrawler.request_pair_api("", left, right), "")
        self.assertEquals(BitstampCrawler.request_pair_api(None, left, right), "")
    ...
    def test_request_pair_api_raise_exception_for_invalid_url(self):
        ...
        with self.assertRaises(ConnectionError) as context:
            BitstampCrawler.request_pair_api(exchange.orderbook_api, left, right)
    ...
    def test_request_pair_api_returns_any_result_for_exchange_url(self):
        ...
        result = BitstampCrawler.request_pair_api(exchange.orderbook_api, left, right)
    ...
    def test_request_pair_api_returns_proper_result_for_ticker_api(self):
        ...
        result = BitstampCrawler.request_pair_api(exchange.ticker_api, left, right)
    ...
    def test_parse_pair_orderbook_returns_empty_lists_for_empty_response(self):
        ...
        result = BitstampCrawler.parse_pair_orderbook("")
        self.assertEquals(type(result[0]), list)
        self.assertFalse(result[0])
        self.assertEquals(type(result[1]), list)
        self.assertFalse(result[1])

        result = BitstampCrawler.parse_pair_orderbook(None)
        self.assertEquals(type(result[0]), list)
        self.assertFalse(result[0])
        self.assertEquals(type(result[1]), list)
        self.assertFalse(result[1])
    ...
    def test_parse_pair_orderbook_returns_parsed_data_for_mocked_response(self):
        ...
        result = BitstampCrawler.parse_pair_orderbook(response)
    ...
    def test_parse_pair_ticker_returns_empty_list_for_empty_response(self):
        result = BitstampCrawler.parse_pair_ticker("")
        self.assertIsNone(result[0])
        self.assertIsNone(result[1])

        result = BitstampCrawler.parse_pair_ticker(None)
        self.assertIsNone(result[0])
        self.assertIsNone(result[1])
    ...
    def test_parse_pair_ticker_returns_parsed_data_for_mocked_response(self):
        ...
        result = BitstampCrawler.parse_pair_ticker(response)
    ...
    def test_save_pair_orderbook_for_invalid_pair(self):
        orderbook = BitstampCrawler.parse_pair_orderbook(self.orderbook_response)

        result = BitstampCrawler.save_pair_orderbook(None, orderbook[0], orderbook[1])
    ...
    def test_save_pair_orderbook_for_not_existing_pair(self):
        ...
        result = BitstampCrawler.save_pair_orderbook(exchange_pair, orderbook[0], orderbook[1])
    ...
    def test_save_pair_orderbook_for_valid_pair_and_empty_orderbook(self):
        ...
        result = BitstampCrawler.save_pair_orderbook(crawler.exchange.pairs.first(), [], [])
    ...
    def test_save_pair_ticker_for_invalid_pair(self):
        ticker = BitstampCrawler.parse_pair_ticker(self.ticker_response)

        result = BitstampCrawler.save_pair_ticker(None, ticker[0], ticker[1])
    ...
    def test_save_pair_ticker_for_not_existing_pair(self):
        ...
        exchange_pair = ExchangePair()
        result = BitstampCrawler.save_pair_ticker(exchange_pair, ticker[0], ticker[1])
    ...
    def test_save_pair_ticker_for_valid_pair_and_empty_orderbook(self):
        ...
        result = BitstampCrawler.save_pair_ticker(crawler.exchange.pairs.first(), None, None)
