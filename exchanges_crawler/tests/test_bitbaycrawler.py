...
class BitBayCrawlerTestCase(TestCase):
    ...
    def test_crawler_is_properly_created(self):
        crawler = BitBayCrawler(self.exchange)

        self.assertEquals(self.exchange.id, crawler.exchange.id)
    ...
    def test_request_pair_api_raise_exception_for_invalid_url(self):
        orderbook_api = 'invalid_api_url'
        left, right = 'BTC', 'USD'

        with self.assertRaises(ConnectionError) as context:
            BitBayCrawler.request_pair_api(orderbook_api, left, right)
    ...
    def test_request_pair_api_returns_any_result_for_exchange_url(self):
        orderbook_api = 'https://bitbay.net'
        left, right = 'BTC', 'USD'

        result = BitBayCrawler.request_pair_api(orderbook_api, left, right)
    ...
    def test_request_pair_api_returns_proper_result_for_orderbook_api(self):
        ...
        result = BitBayCrawler.request_pair_api(self.orderbook_api, left, right)
    ...
    def test_request_pair_api_returns_proper_result_for_ticker_api(self):
        ...
        result = BitBayCrawler.request_pair_api(self.ticker_api, left, right)
    ...
    def test_save_pair_orderbook_for_invalid_pair(self):
        crawler = BitBayCrawler(self.exchange)
        orderbook = crawler.parse_pair_orderbook(self.orderbook_response)

        result = crawler.save_pair_orderbook(None, orderbook[0], orderbook[1])
    ...
    def test_save_pair_orderbook_for_not_existing_pair(self):
        ...
        result = crawler.save_pair_orderbook(exchange_pair, orderbook[0], orderbook[1])
    ...
    def test_save_pair_orderbook_for_valid_pair_and_empty_orderbook(self):
        ...
        result = crawler.save_pair_orderbook(crawler.exchange.pairs.first(), [], [])
    ...
    def test_save_pair_ticker_for_invalid_pair(self):
        crawler = BitBayCrawler(self.exchange)
        ticker = crawler.parse_pair_ticker(self.ticker_response)

        result = crawler.save_pair_ticker(None, ticker[0], ticker[1])
    ...
    def test_save_pair_ticker_for_not_existing_pair(self):
        ...
        result = crawler.save_pair_ticker(exchange_pair, ticker[0], ticker[1])
    ...
    def test_save_pair_ticker_for_valid_pair_and_empty_orderbook(self):
        ...
        result = crawler.save_pair_ticker(crawler.exchange.pairs.first(), None, None)
